              ...
              {new Array(3).fill(1).map((name, index) => {
                return (
                  <div
                    ...
                    `}
                  >
                    <img alt="" src="https://gw.alipayobjects.com/zos/antfincdn/6FTGmLLmN/bianzu%25252013.svg" />
                    <div
                      style={{
...
const App = function() {
  const [settings, setSetting] = useState<Partial<ProSettings> | undefined>(themeSettins);
